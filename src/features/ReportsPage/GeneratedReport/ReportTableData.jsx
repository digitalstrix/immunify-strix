...
const dialogContent = (loadingStatus, { columns, data, actions, title }) => (
  <Box m={3}>
    {
      loadingStatus ? <Loader height={'40vh'}/> :
      <Table
          title={title}
...
const Reporttabledata = () => {
  ...
  const seondaryReportLoadingStatus = useSelector(selectSecondaryReportLoadingStatus);
    ...
    <div>
      <MainDialog                    
        ...
        dialogcontent={dialogContent(
          ...
          { columns: secondaryReportColumns, data: secondaryReportData, actions: [], title: secondaryTitle})
        }
