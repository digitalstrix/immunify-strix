...
export default function ApproveEmail(data) {
  ...
  const [navigationSetup, setNavigationSetup] = useState(rowData.navigationSetup ? rowData.navigationSetup : null);
              ...
              {(uType === "PARENTS" || uType === "DOCTORS") && (
                <Grid item xs={12}>
                  <Autocomplete
                    ...
                    onChange={(event, value) => setNavigationSetup(value?.value)}
                  />
                </Grid>
              )}
