...
import { setCallStatus } from "../../Parent/CallView/callViewSlice";
import { getLoggedInUserId } from "./selector";
import {
  selectSettingCallCompleteError,
  selectSettingCallCompleteStatus,
} from "../../Parent/CallView/selector";
import { setCallData } from "../MyAppointmentsPage/myAppointmentsSlice";

function App() {
  const dispatchAction = useDispatch();
  const { enqueueSnackbar } = useSnackbar();
  const { uid, channel, token, slotId, userName } = useSelector(selectCallData);
